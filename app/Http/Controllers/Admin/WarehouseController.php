...
class WarehouseController extends Controller
{
    ...
    public function __construct(Warehouse $warehouse, WarehouseHistory $warehouse_history, Order $order, OrderDetail $order_detail, WarehouseHistoryDetail $warehouse_history_detail){
