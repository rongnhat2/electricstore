...
class OrderController extends Controller
{
    ...
    public function __construct(Product $product, Customer $customer, Order $order, OrderDetail $order_detail, Warehouse $warehouse){
    ...
    public function get_one($id){
        $order = $this->order->get_one($id);
        $order_detail = $this->order->get_detail($id);
        $order_group = [
            "order"         => $order,
